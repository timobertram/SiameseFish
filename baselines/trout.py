...
class TroutBot(Player):
    ...
    def choose_move(self, move_actions: List[chess.Move], seconds_left: float) -> Optional[chess.Move]:
        ...
        if enemy_king_square:
            ...
            empty_squares = [square for square in range(64) if self.board.piece_at(square) is None]
            self.board.set_piece_at(random.choice(empty_squares),chess.Piece(chess.KING,not self.color))
