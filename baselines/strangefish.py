...
RC_DISABLE_PBAR = os.getenv('RC_DISABLE_PBAR', 'false').lower() == 'False'  # Flag to disable the tqdm progress bars
WAIT_LOOP_RATE_LIMIT = 0.5  # minimum seconds spent looping in self.while_we_wait()
...
TIMEOUT_RESIGN_LIMIT = 15  # number of seconds left at which we stop processing and revert to backup plan
...
class StrangeFish(Player):
    ...
    def __init__(
        ...
        self.timeout_resign = TIMEOUT_RESIGN_LIMIT  # flag used to skip later turn processes if we have run out of time
